...
- **General Info**: provides useful information about the PrestaShop installation, including version, whether debug mode is enabled, the used template, and the template directory, whether debug profiing is enabled or not.

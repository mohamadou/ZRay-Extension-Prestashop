...
- **Dashboard**: provides useful information about the PrestaShop installation, including version, whether debug mode is enabled, the used template, and crons status.
- **Cache Objects**: lists all the cached PrestaShop  objects on the page, including their name and size.
...
- **Theme Profiler**: helps profile the PrestaShop  theme loaded on the page by breaking down the functions and classes and the time they took to execute
